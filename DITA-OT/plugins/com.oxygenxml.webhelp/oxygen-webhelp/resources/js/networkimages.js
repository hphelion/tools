    	if (document.getElementsByClassName('allNetworks').length) {
    	var theclass=document.getElementsByClassName('allNetworks midKvmVsa');
    	var thename=theclass[0].className;
    	var res=thename.search(midKvmVsa);
    	if (res !== -1) {
...
var getnetworks=document.getElementsByClassName('allNetworks midKvmVsa');
