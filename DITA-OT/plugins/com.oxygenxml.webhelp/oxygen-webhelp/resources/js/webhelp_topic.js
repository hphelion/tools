...
if (document.getElementsByClassName("keystoneVideo").length) {
   vidDiv=document.getElementsByClassName("keystoneVideo");
    ...
    vidDiv[0].innerHTML='<video width="1040" height="585" controls><source src="../../../3.x/media/video/keyMovie.mp4" type="video/mp4">Your browser does not support the video tag.</video>';
}
