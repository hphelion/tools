...
echo ">>rsync /var/www/html/euca-incoming/staging  to /var/www/html/eucaProd/$VERSION_TO_PUBLISH "
rsync -avr --delete   /var/www/html/euca-incoming/staging/* ubuntu@${SERVER1}:/var/www/html/eucaProd/$VERSION_TO_PUBLISH
