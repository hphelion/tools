...
if [[ $(diff files.in.dita.txt files.on.disk.txt  | grep ">" | sed 's|>||g') ]]
    then
                ...
                echo "================================================================================"
				./hipchat-notification.sh green  145  "Unused graphics found in the $REPO_BRANCH_TO_CHECK branch of the $REPO repo" 1
                exit 1;
    else
                echo "========================"
                echo "No unused graphics found"
                echo "========================"
                ./hipchat-notification.sh green  145  "No unused graphics found" 0
                exit 0;
fi
