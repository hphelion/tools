...
if [[ $(diff files.in.dita.txt files.on.disk.txt  | grep ">" | sed 's|>||g') ]]
    then
                ...
                echo "================================================================================"
				./hipchat-notification.sh red  845  "Build $BUILD_NUMBER $STATUS - Unused graphics found in the $REPO_BRANCH_TO_CHECK branch of the $REPO repo. Details <a href='$BUILD_URL/console'>here</a>." 1
                exit 1;
    else
                echo "========================"
